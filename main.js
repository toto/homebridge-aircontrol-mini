...
function CO2Accessory(log, config) {
  ...
  this.informationService.setCharacteristic(Characteristic.Manufacturer, "TFA-Dostmann");
  this.informationService.setCharacteristic(Characteristic.Model, "AirControl Mini")
